...
>(
    (
        ...
        // We assume the sidebar is mobile when the screen is smaller than 768px.
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                // Increases the hit area of the button on mobile.
                "after:absolute after:-inset-2 after:md:hidden",
                "peer-data-[level=0]:peer-data-[collapsible=icon]:hidden",
                "peer-data-[level=1]:peer-data-[collapsible=icon]:hidden",
                "peer-data-[level=2]:peer-data-[collapsible=icon]:hidden",
                className
            )}
            {...props}
        />
    ...
    const button = (
        <Comp
            ...
            className={cn(
                ...
                "h-8 data-[collapsible=icon]:!size-8 data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
